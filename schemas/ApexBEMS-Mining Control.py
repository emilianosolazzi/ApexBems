...
"$id": "https://apexbems.local/schemas/apexbems-miner-command-v1.schema.json",
...
"command_type": {
"type": "string",
"enum": ["set_power_limit", "curtail", "resume", "hold"],
"default": "set_power_limit"
},
"target_power_kw": {
"type": "number",
"minimum": 0
